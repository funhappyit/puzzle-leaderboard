...
> **동시성 제어 · Redis 캐싱 · 분산 환경 배포** 

> 📅 **개발 기간**: 2026.06.30 ~ 2026.07.05 (6일)
...
- [기술 블로그 글](https://amiesoft-hyk.github.io/2026/07/10/puzzle-leaderboard-tech-stack/)
...
단순 CRUD가 아니라 **JMeter 부하 테스트로 race condition을 재현**하고,  
Redis 분산락 적용 전/후 TPS를 비교하며 트레이드오프를 기록한다.
